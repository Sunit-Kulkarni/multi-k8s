...
kubectl set image deployments/client-deployment server=sunitkulkarni/multi-client:$SHA
kubectl set image deployments/worker-deployment server=sunitkulkarni/multi-worker:$SHA